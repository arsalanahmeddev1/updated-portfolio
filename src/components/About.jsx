...
const About = () => {
  ...
  return (
    <>
      ...
      I'm a skilled full-stack developer with expertise in modern JavaScript frameworks on the frontend—particularly React—and Laravel on the backend. I build robust, scalable web applications using both Inertia.js and API-based architectures. I’m a fast learner who collaborates closely with clients to deliver efficient, user-friendly solutions that solve real-world problems. Let’s work together to bring your ideas to life!
      </p>
